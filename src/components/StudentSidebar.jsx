...
const NAV = [
  ...
  { to: '/student/complaints/new', icon: '+',  label: 'New Complaint', iconStyle: true },
  { to: '/student/notifications',  icon: '🔔', label: 'Notifications', badge: true },
  ...
  return (
    <aside className="flex flex-col w-60 bg-white dark:bg-gray-900 border-r border-tce-dark/[0.08] dark:border-gray-700/50 h-full py-5 px-4">
      ...
      <div className="flex items-center gap-3 mb-7 pb-5 border-b border-tce-dark/10 dark:border-gray-700/50">
        {/* Logo with tight circular crop — no transparent padding */}
      ...
      <nav className="flex flex-col gap-1 flex-1">
        {NAV.map(({ to, icon, label, badge, iconStyle }) => (
      ...
      <div className="mt-auto pt-5 border-t border-tce-dark/10 dark:border-gray-700/50">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleLogout} className="btn-outline flex-1 text-xs py-1.5">
            Logout
          </button>
        </div>
      </div>

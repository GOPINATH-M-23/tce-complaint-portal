...
export default function AdminDashboard() {
  ...
  // Dynamically filtered list for the recent-complaints panel
  ...
  return (
    <div className="space-y-5 md:space-y-7 mt-4">
      ...
      {/* Stat cards — Pending, Resolved, In Progress are clickable filters */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        {/* Total — not a filter, navigates to all complaints */}
      ...
      <div className="grid lg:grid-cols-5 gap-5 md:gap-6">
        {/* Complaints list — filtered by active stat card */}
              ...
              <div className="space-y-3 max-h-80 overflow-y-auto pr-1">
                {adminNotifs.map((n) => (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-gray-400">{formatRelative(n.createdAt)}</p>
                  </div>
                ))}
              </div>
            )}

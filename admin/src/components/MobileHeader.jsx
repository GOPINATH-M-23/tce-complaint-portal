    ...
    <div className="md:hidden flex items-center justify-between px-4 py-2.5 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700/50 sticky top-0 z-30 min-w-0 overflow-hidden">
      ...
      <div className="flex items-center gap-2 shrink-0 ml-2">
        <button
          ...
          className="relative flex items-center justify-between w-14 h-7 rounded-full px-1.5 border-0 cursor-pointer transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-tce-green/40 shrink-0"
